    ...
    return (
        <section className="px-52 pt-32 pb-20 flex justify-between">
            <div className="w-[70%] flex flex-col" id="privacy-policy">
                ...
                <span className="mt-3">
                    Last updated : <span className="text-neutral-500 italic">August 13, 2024</span>
                </span>
                ...
                <div className="mt-5 space-y-3">
                    ...
                    <h5 className="font-semibold text-xl text-cyan-900">
                        Interpretation
                    </h5>
                    <p>
                    ...
                    <ul className="list-disc ml-10 space-y-2">
                        ...
                        <li>
                            Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to tupcure, indonesia.
                        </li>
                        <li>
                    ...
                    <h5 className="font-semibold text-xl text-cyan-900">Types of Data Collected</h5>
                    <h6 className="font-semibold text-lg text-neutral-800">
                        Personal Data
                    </h6>
                    <p>
                    ...
                    <ul className="ml-8 space-y-5 list-disc">
                        <li>
                    ...
                    <p>
                        Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on <Link href={"https://www.termsfeed.com/blog/cookies/#What_Are_Cookies"} className="text-purple-1">[TermsFeed website]</Link> article.
                    </p>
                    <p>
                    ...
                    <ul className="list-disc ml-8">
                        <li>
                            <div className="space-y-1">
                                <h6 className="text-lg font-semibold">Necessary / Essential Cookies</h6>
                                <p>
                        ...
                        <li>
                            <div className="space-y-1">
                                <h6 className="text-lg font-semibold">Cookies Policy / Notice Acceptance Cookies</h6>
                                <p>
                        ...
                        <li>
                            <div className="space-y-1">
                                <h6 className="text-lg font-semibold">Functionality Cookies</h6>
                                <p>
                                    Type: Persistent Cookies
                                </p>
                                <p>
                    ...
                    <h6 className="text-lg font-semibold text-neutral-800">
                        Law enforcement
                    </h6>
                    <p>
                    ...
                    <ul className="ml-8 list-disc">
                        <li>
                            By email: tuppsoftware@gmail.com
                        </li>
                    </ul>
                </div>
            </div>
